...
The hardest part was reliable serial communication between the Arduino and the Raspberry Pi. Baud-rate mismatches caused inconsistent data, with delayed or corrupted readings.
